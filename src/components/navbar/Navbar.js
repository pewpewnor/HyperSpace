            ...
            <div className='account-information-container'>
                <div className='user-information-data-container'>
                    ...
                    <div className='user-subscription-container'>
                        ...
                        <Icon icon="ph:crown-simple-fill" className={iconMembership}/>
                    </div>
                </div>
    ...
    return(
        <div className="navbar-container">
            <div className="logo-container">
                <img src={require('./logo-hyperSpace.png')} alt="logo"></img>
                <div className="logo-name-container">
                    <h1 id="logo-first">Hyper</h1><h1 id="logo-second">Space</h1>
                </div>
            </div>

            <div className="search-bar-container">
                <div className="search-bar">
                    <span><Icon icon="ic:baseline-search" className='search-icon'/></span>
                    <input className="search-input" placeholder='Search anything here...' onKeyDown={handleSearch}></input>
                </div>
            </div>
